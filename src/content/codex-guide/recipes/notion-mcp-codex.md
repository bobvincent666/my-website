...
![image-20260513114556044](/codex-guide/images/image-20260513114556044.png)
...
![image-20260513114704338](/codex-guide/images/image-20260513114704338.png)
...
![image-20260513114814177](/codex-guide/images/image-20260513114814177.png)
...
![image-20260513115012265](/codex-guide/images/image-20260513115012265.png)

### 总结与写入

读取到内容之后，可以让 Codex 直接进行总结。如果对话中产生了不错的想法，也可以让它**直接写入到你的 Notion 工作空间**，完成后会返回一个写入成功的链接：

![image-20260513115116664](/codex-guide/images/image-20260513115116664.png)

点击链接跳转到 Notion 查看写入结果，内容完全正常：

![image-20260513115207197](/codex-guide/images/image-20260513115207197.png)
