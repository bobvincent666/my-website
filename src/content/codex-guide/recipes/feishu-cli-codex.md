...
![image-20260513095627052](/codex-guide/images/image-20260513095627052.png)
...
![image-20260513095651533](/codex-guide/images/image-20260513095651533.png)

打开链接，创建应用：

![image-20260513124054417](/codex-guide/images/image-20260513124054417.png)

按照它的指引创建应用之后，把 App ID 和 App Secret 发给它，Codex 会自动完成飞书应用配置和权限申请。

![image-20260513095837118](/codex-guide/images/image-20260513095837118.png)

> 过程中会涉及**手动授权**操作。Codex 会提供跳转链接，点击在浏览器里放行对应权限即可，这样它才能读取和操作你的飞书数据。

![image-20260513100002206](/codex-guide/images/image-20260513100002206.png)
...
![image-20260513100034664](/codex-guide/images/image-20260513100034664.png)

Codex 还会贴心地告诉你第一次应该怎么用，连提示词都帮你准备好了。

![image-20260513100141955](/codex-guide/images/image-20260513100141955.png)
...
![image-20260513100230490](/codex-guide/images/image-20260513100230490.png)
...
![image-20260513100349487](/codex-guide/images/image-20260513100349487.png)
