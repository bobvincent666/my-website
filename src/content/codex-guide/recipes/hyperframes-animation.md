...
![image-20260512215014826](/codex-guide/images/image-20260512215014826.png)
...
![image-20260512215253160](/codex-guide/images/image-20260512215253160.png)

任务完成之后，它会告诉我们**返回本地文件的地址**，点击即可跳转查看具体内容。

![image-20260512215544769](/codex-guide/images/image-20260512215544769.png)

如果你仔细观察，会发现实际上它是**生成了几张 JPEG 格式的图片，然后将图片组装成视频**。大概是这样一个过程。

![image-20260512215633692](/codex-guide/images/image-20260512215633692.png)
...
![image-20260512215719224](/codex-guide/images/image-20260512215719224.png)
