...
#### 第一章 Claude Code概述
- [1.1 Claude Code是什么](#11-claude-code是什么)
  - [1.1.1 Claude Code的定义](#111-claude-code的定义)
  - [1.1.2 Claude Code的发展背景](#112-claude-code的发展背景)
  - [1.1.3 Claude Code的核心定位](#113-claude-code的核心定位)
  - [1.1.4 Claude Code的技术基础](#114-claude-code的技术基础)
  - [1.1.5 Claude Code的主要组成部分](#115-claude-code的主要组成部分)
  - [1.1.6 Claude Code与传统AI编程工具的本质区别](#116-claude-code与传统ai编程工具的本质区别)
  - [1.1.7 Claude Code的设计原则](#117-claude-code的设计原则)
  - [1.1.8 Claude Code的应用前景](#118-claude-code的应用前景)
...
**区分Claude Code和Claude大模型。** Claude Code是一个工具软件，不能与Claude大模型划等号。虽然Claude Code的官方团队，在工具内默认使用Claude大模型，但是我们可以通过配置来使用非官方的大模型，例如使用国内的GLM等大模型。 这也展示了AI助手的灵活性和可扩展性，使得开发者能够根据自己的需求和场景，选择最适合的模型。 虽然目前市面上的编程模型中Claude 4.5 Opus是最聪明最强的，但是因为太贵，实际上我们在实际开发中，更多的是使用国内的GLM等模型。
